...
class UserOption extends XFCP_UserOption
{
    protected function _setupDefaults()
    {
        ...
        $this->sv_alerts_popup_skips_mark_read = isset($defaults['sv_alerts_popup_skips_mark_read']) ? $defaults['sv_alerts_popup_skips_mark_read'] : true;
        $this->sv_alerts_page_skips_mark_read = isset($defaults['sv_alerts_page_skips_mark_read']) ? $defaults['sv_alerts_page_skips_mark_read'] : true;
    ...
    public static function getStructure(Structure $structure)
    {
        ...
        $structure->columns['sv_alerts_popup_skips_mark_read'] = ['type' => Entity::BOOL, 'default' => 1];
