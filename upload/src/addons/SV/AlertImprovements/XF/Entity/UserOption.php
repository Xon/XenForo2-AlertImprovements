 ...
 *
 * @property bool $sv_prompt_on_mark_read
...
class UserOption extends XFCP_UserOption
{
    ...
    protected function _setupDefaults()
    {
        ...
        $this->sv_prompt_on_mark_read = (string)($defaults['sv_prompt_on_mark_read'] ?? true);
    ...
    public static function getStructure(Structure $structure)
    {
        ...
        $structure->columns['sv_prompt_on_mark_read'] = ['type' => Entity::BOOL, 'default' => true];
